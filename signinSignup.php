                    ...
                    <div class="row">
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="signinBackend.php" method="post" class="login-form">
				                    	<div class="form-group">
				                    		<label class="sr-only" for="form-username">Username</label>
				                        	<input type="text" name="emailid" placeholder="Username..." class="form-username form-control" id="emailid">
				                        </div>
				                        <div class="form-group">
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="signupBackend.php" method="post" class="registration-form">
				                    	<div class="form-group">
				                        ...
				                        <div class="form-group">
				                        	...
				                        	<textarea name="aboutyourself" placeholder="About yourself..." 
				                        				class="form-about-yourself form-control" id="aboutyourself"></textarea>
				                        </div>
